...
# GPTHub fork: slim by default (no embedding/whisper weight preload at build; use external APIs).
# Full local RAG/STT offline image: docker build --build-arg USE_SLIM=false ...
ARG USE_SLIM=true
